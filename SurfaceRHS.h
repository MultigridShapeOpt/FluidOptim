...
#ifndef SURFACE_DESIGN_EQUATION
#define SURFACE_DESIGN_EQUATION
...
namespace ug{
	namespace FluidOptim{
		...
		*/
		...
		class SurfaceRHS: public IElemDisc<TDomain>
		{
			protected:
				///	Base class type
				...
				typedef SurfaceRHS<TDomain> this_type;
			...
			public:
				///constructor
				SurfaceRHS(const char* functions, const char* subsets);
				///destructor
				//virtual ~SurfaceRHS();
