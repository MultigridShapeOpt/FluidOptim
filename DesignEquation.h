...
#ifndef DESIGN_EQUATION
#define DESIGN_EQUATION
...
namespace ug{
	namespace FluidOptim{
		...
		*/
		...
		class DesignEquation: public IElemDisc<TDomain>
		{
			protected:
				///	Base class type
				...
				typedef DesignEquation<TDomain> this_type;
			...
			public:
				///constructor
				DesignEquation(const char* functions);
				///destructor
				//virtual ~DesignEquation();
