...
*/
 ...
 #ifndef BOUNDARY__CONTROL
#define BOUNDARY__CONTROL
...
namespace ug{
	namespace FluidOptim{
		...
		*/
		...
		class BoundaryControl: public IElemDisc<TDomain>
		{
			protected:
				///	Base class type
				...
				typedef BoundaryControl<TDomain> this_type;
			...
			public:
				...
				///Position type
			public:
				void set_boundary_inner_subsets(const char* BndSubsets, const char* InnerSubsets);
				void set_fixed_boundary_control(number n,const char* BndSubsets, const char* InnerSubsets);
				void set_variable_boundary_control(bool control);
				/*
		...
		#ifdef UG_FOR_LUA
				void set_boundary_control(const char* fctName);
				void set_boundary_control(LuaFunctionHandle fct);
		#endif
				bool check_boundary_control();
				//bool check_value_boundary_control(number val);
			...
			protected:
				...
				std::string m_BndSubsetNames;
				SubsetGroup m_vBndSSGrp;
				//border control
				number m_boundary_control;
				bool m_bVariableBoundaryControl;
				DataImport<number,dim> m_imBoundaryControl;
			//CONSTRUCTOR
			public:
				///constructor
				BoundaryControl(const char* functions);
				///destructor
